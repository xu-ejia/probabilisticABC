...
entrechmentA([Axiom|RestAs], SuffsIn, IncompsIn, EntStateTem, EntState, (T1,T2), TotalScores):-
  ...
  findall(C,
    ...
    sum_list(CList2,  C2),
    length(CList2, C2Length),
    Ent1 is E1-E2,
    Ent2 is C1-C2,
    WTrue is E1+C1,
    WFalse is E2+C2,
    TrueNum is C1Length + E1,
    FalseNum is C2Length + E2,
    EntAxiom = [(WTrue, WFalse, TrueNum, FalseNum), Axiom],
    T1new is Ent1 + T1,
    T2new is Ent2 + T2,
...
run:- main("C:/Users/XUEJIA/PABC/data/-0.0625_0_1_1_2/repair/triples.txt","C:/Users/XUEJIA/PABC/data/-0.0625_0_1_1_2/repair/rules.txt","C:/Users/XUEJIA/PABC/data/-0.0625_0_1_1_2/repair/proofs.txt","C:/Users/XUEJIA/PABC/data/-0.0625_0_1_1_2/repair/probability").